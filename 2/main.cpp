...
void spinDisplay(void)
{
	...
	*/
	...
	currentSpin += spinSpeed * (currentTime - prevTime) / 1000;
...
void printUserInteraction() {
	...
	*/
	...
	cout << "Click left mouse button, to spin the scene in counter-clockwise";
	cout << "Click right mouse button, to spin the scene in clockwise";
	cout << "Presse space button, to stop spinning";
	//---------------------------------------
}
